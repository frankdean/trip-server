...
describe('gpx-upload.js', function() {
  ...
  describe('Test import single waypoint', function() {
    ...
    it('should import a single waypoint', function() {
      ...
      expect(db.createItineraryWaypoints).toHaveBeenCalledWith(testItineraryId, [ Object({ lat: '51.51743317', lng: '-0.13483334', time: '2016-11-02T19:28:50.000Z', ele: '100.00000', name: 'London', cmt: 'Test Comment 1', desc: 'Test description 1', sym: 'City (Capitol)', type: 'My Type', color: '#b400842b', samples: '1' }) ], jasmine.any(Function));
    });
  ...
  describe('Test import waypoints, tracks and routes', function() {
    ...
    beforeEach(function(done) {
      GpxUpload.importFile(testItineraryId, './spec/TestWaypointTrackRoute.gpx', false, function(_err_, _result_) {
        err = _err_;
        result = _result_;
        done();
      });
    ...
    it('should upload the named file', function() {
      ...
      expect(db.createItineraryTracks).toHaveBeenCalledWith(testItineraryId, [ Object({ segments: [ Object({ points: [ Object({ lat: '18.49486923', lng: '-64.45214081', time: '1970-01-01T00:00:01.000Z', ele: '100.00000', hdop: '140.0' }), Object({ lat: '45.40974808', lng: '-105.49706268', time: '1970-01-01T00:00:02.000Z', ele: '100.00000' }), Object({ lat: '-3.32189083', lng: '-133.70994568', time: '1970-01-01T00:00:03.000Z', ele: '100.00000' }), Object({ lat: '-0.59913325', lng: '-90.73143768', time: '1970-01-01T00:00:04.000Z', ele: '100.00000' }), Object({ lat: '4.05566788', lng: '-6.79588938', time: '1970-01-01T00:00:05.000Z', ele: '100.00000' }), Object({ lat: '-9.08620834', lng: '13.4189539', time: '1970-01-01T00:00:06.000Z', ele: '100.00000' }) ] }), Object({ points: [ Object({ lat: '-33.34461975', lng: '17.81348419', time: '1970-01-01T00:00:07.000Z', ele: '100.00000' }), Object({ lat: '-34.80059052', lng: '26.07520294', time: '1970-01-01T00:00:08.000Z', ele: '100.00000' }), Object({ lat: '-25.94357681', lng: '44.26856232', time: '1970-01-01T00:00:09.000Z', ele: '100.00000' }), Object({ lat: '11.79707623', lng: '51.12403107', time: '1970-01-01T00:00:10.000Z', ele: '100.00000' }), Object({ lat: '36.11537552', lng: '-5.8290925', time: '1970-01-01T00:00:11.000Z', ele: '100.00000' }), Object({ lat: '38.62944031', lng: '-27.8896389', time: '1970-01-01T00:00:12.000Z', ele: '100.00000' }), Object({ lat: '11.79707623', lng: '-61.20018387', time: '1970-01-01T00:00:13.000Z', ele: '100.00000' }) ] }) ], name: 'Test track one', color: 'Green', distance: 50185.78222178865, highest: 100, lowest: 100, ascent: 0, descent: 0 }), Object({ segments: [ Object({ points: [ Object({ lat: '17.49486923', lng: '-54.45214081', time: '1970-01-01T00:00:01.000Z', ele: '100.00000', hdop: '140.0' }), Object({ lat: '42.40974808', lng: '-75.49706268', time: '1970-01-01T00:00:02.000Z', ele: '100.00000' }) ] }) ], name: 'Test track two', color: 'Yellow', distance: 3413.351800788805, highest: 100, lowest: 100, ascent: 0, descent: 0 }) ], jasmine.any(Function));

      expect(db.createItineraryWaypoints).toHaveBeenCalledWith(testItineraryId, [ Object({ lat: '51.51743317', lng: '-0.13483334', time: '2016-11-02T19:28:50.000Z', ele: '100.00000', name: 'London', cmt: 'Test Comment 1', desc: 'Test description 1', sym: 'City (Capitol)', type: 'My Type', color: '#b400842b', samples: '1' }), Object({ lat: '43.6143837', lng: '3.86420012', time: '2016-11-02T19:29:08.000Z', name: 'Montpellier', cmt: 'Test Comment 2', desc: 'Test description 2', sym: 'City (Large)', samples: '2' }), Object({ lat: '48.85945129', lng: '2.33159995', time: '2016-11-02T19:28:15.000Z', name: 'Paris', cmt: 'Test Comment 3', desc: 'Test description 3', sym: 'City (Capitol)', color: '#b400842b' }) ], jasmine.any(Function));

...
echo "  signingKey: \"${TRIP_SIGNING_KEY}\"" >> config.yaml
echo "  resourceSigningKey: \"${TRIP_RESOURCE_SIGNING_KEY}\"" >> config.yaml
...
echo "  uri: postgresql://trip:${POSTGRES_PASSWORD}@postgis/trip" >>config.yaml
